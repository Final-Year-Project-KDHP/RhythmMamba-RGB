...
class RMambaTrainer(BaseTrainer):
    ...
    def preprocess_red_channel(self, data):
        ...
        Args:
            data: Tensor of shape [N, D, 3, H, W] (RGB).
        Returns:
            data_r: Tensor of shape [N, D, 1, H, W] with the R channel only.
        """
        data_r = data[:, :, 0:1, :, :]  # index 0 for the R channel
        return data_r
    ...
    def train(self, data_loader):
        ...
        for epoch in range(self.max_epoch_num):
            ...
            for idx, batch in enumerate(tbar):
                ...
                # Preprocess: extract Red channel if desired
    ...
    def test(self, data_loader):
        ...
        with torch.no_grad():
            ...
            for _, test_batch in enumerate(tbar):
                ...
                # Optionally preprocess red channel for test
